...
const styles = {
  ...
  'nav-tooltip':
    'shadow-lg inline-block absolute invisible z-10 py-2 transform-x-4 px-3 text-sm font-medium text-white bg-gray-700 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-600',
};
